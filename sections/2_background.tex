...
That last point is the one the rest of the thesis turns on, so it is worth stating mechanically. When
the action is an $\arg\max$ over per-alternative scores, a
