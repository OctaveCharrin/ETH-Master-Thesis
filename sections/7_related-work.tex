...
head-of-line-blocking failure mode. They belong here because they are the status quo the learned
scheduler of \cref{ch:multipath} improves on. minRTT is now \emph{measured} against in
\cref{tab:p2results} --- it is the strongest of the five fixed rules there, and the learned pair leads
it by 0.139--0.250 QoE --- so this section should cite it rather than leaving the comparison
undiscussed; BLEST and ECF remain uncompared and should be named as such.
