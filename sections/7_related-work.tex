...
objectives (e.g.\ minimizing congestion globally) from a control-plane vantage point. Our Part~I differs in
...
and FiLM-based intent conditioning that removes the single-objective limitation -- are the substance of
Part~I.
...
environments; both optimize a scheduling policy for a given, exogenous load. Part~II's distinction is that it
...
VMAF~\cite{VMAF2016}. Our Part~II shares the QoE-driven, learned-bitrate stance but targets \emph{real-time}
