...
contribution is a specific insight about that gap: for a comparison-based (argmax or softmax) selector,
conditioning must reach the per-alternative terms, because an additive, symmetric signal cancels under
the comparison (\cref{sec:p1design:conditioning}). This connects a general representation-learning idea
to a concrete failure mode in networked decision-making.
