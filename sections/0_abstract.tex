...
at less than half the parameter count, and brings a learned selector within 0.25\% of a per-context
oracle while probing one path per decision instead of thirty.
